...
- **Resident Registry**: Bảng `residents` là nguồn dữ liệu tổng hợp dân số duy nhất của hệ thống. Mọi số liệu dân số theo xã/phường, tổng quan và phân bố dân tộc được tính từ các bản ghi này; `communes` chỉ lưu danh mục địa lý và trạng thái vận hành.
